...
while True:
    ...
    # Collect CPU usage (average over 5 seconds)
    cpu_percent_overall = psutil.cpu_percent(interval=5)
    ...
    if previous_network_io is not None and previous_time is not None:
        ...
        for interface, io in current_network_io.items():
            ...
            if prev_io:
                ...
                network_rates[interface] = {"bytes_sent_per_sec": 0, "bytes_recv_per_sec": 0,
    ...
    json_body = [
        ...
        *[{"measurement": "cpu_usage_per_core", "tags": {"core_id": i}, "fields": {"percent": percent}}
          for i, percent in enumerate(cpu_percent_per_core)],
        {"measurement": "memory_usage", "fields": {"total": memory.total, "used": memory.used,
                                                  "free": memory.free, "percent": memory.percent}},
        *[{"measurement": "disk_usage", "tags": {"partition": partition}, "fields": {"total": usage.total,
                                                                                   "used": usage.used,
                                                                                   "free": usage.free,
